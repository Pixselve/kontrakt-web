<template>
  <v-expansion-panel :disabled="loading">
    ...
    <v-expansion-panel-content>
      ...
      <v-btn :to="`/teacher/contracts/${contract.id}`" color="primary" text>Compléter les compétences</v-btn>
      <v-btn :disabled="loading" color="red" text @click="deleteContract">Supprimer le contrat</v-btn>
    </v-expansion-panel-content>
  </v-expansion-panel>
</template>
