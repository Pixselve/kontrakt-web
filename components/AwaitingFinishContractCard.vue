<template>
  <v-card height="100%" flat hover shaped class="white--text" :color="contract.rgb">
    ...
    <v-card-text>
      <awaiting-finish-contract-card-skill-item v-if="skill.skillToStudent.mark.value" :key="skill.id" v-for="skill in contract.skills"
