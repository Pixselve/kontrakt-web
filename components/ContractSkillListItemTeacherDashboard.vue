...
export default class ContractSkillListItemTeacherDashboard extends Vue {
  @Prop() readonly skill!: { __typename?: "Skill" } & Pick<
    Skill,
    "id" | "name"
  > & {
      skillToStudents?: Maybe<
        Array<
          { __typename?: "SkillToStudent" } & Pick<
            SkillToStudent,
            "id" | "mark"
          >
        >
  ...
  get skillFinishedSkillToStudent(): ({ __typename?: "SkillToStudent" } & Pick<
    SkillToStudent,
    "id" | "mark"
  >)[] {
    return (
